...
class Tx(rawTx: UByteArray) {
    ...
    // val txid: String = doubleHashSha256(txData.rawTx.bytes).reversedArray().toHexString()
    ...
    //     val message = txWithoutScriptSig.preScriptSig + scriptPubKey + txWithoutScriptSig.postScriptSig + sigHashTo4Bytes(
    //         SigHash.SIGHASH_ALL)
